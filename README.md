...
![My Skills](https://skillicons.dev/icons?i=docker,git,js,githubactions,react,nextjs,linux,discord,md,mongodb,mysql,bash,py,regex,rust,vim,neovim,flask,lua,tailwind,bootstrap,nginx,svelte)
